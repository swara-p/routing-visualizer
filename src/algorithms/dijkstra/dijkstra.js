...
var algo = cy.elements().dijkstra('#t1', function(edge){
  return edge.data('weight');
});

// var algo = cy.elements().aStar({
//   root: '#t1',
//   goal: '#w3',
//   directed: true
// })
...
algo.pathTo("#w3").select()
var i = 0;
var highlightNextEle = function () {
  if (i < algo.pathTo("#w3").length) {
    algo.pathTo("#w3")[i].addClass("highlighted");
    i++;
