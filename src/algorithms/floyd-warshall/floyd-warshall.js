...
algo.path('#network_tower', '#data_centre2').select();

// algo.path.select()
var i = 0;
var highlightNextEle = function () {
  if (i < algo.path('#network_tower', '#data_centre2').length) {
    algo.path('#network_tower', '#data_centre2')[i].addClass("highlighted");
    i++;
