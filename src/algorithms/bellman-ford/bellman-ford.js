...
var algo = cy.elements().bellmanFord({ root: "#network_tower" });

algo.pathTo('#data_centre2').select();
var i = 0;
var highlightNextEle = function () {
  if (i < algo.pathTo('#data_centre2').length) {
    algo.pathTo('#data_centre2')[i].addClass("highlighted");
    i++;
